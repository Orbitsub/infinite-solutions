...
from html_generator import get_last_updated, get_inventory_last_updated, get_inventory_data
import json
import re

PROJECT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
EMBEDDED_DATA_FILE = os.path.join(PROJECT_DIR, 'assets', 'js', 'embedded_data.js')
